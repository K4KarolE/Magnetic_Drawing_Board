...
SHAPES_DIRECTORY = Path(WORKING_DIRECTORY, 'docs', 'skin', 'old', 'shapes')
BACKGROUND_DIRECTORY = Path(WORKING_DIRECTORY, 'docs', 'skin', 'old', 'background')
PICTURES_DIRECTORY = Path(WORKING_DIRECTORY, 'docs', 'skin', 'old', 'pictures')
